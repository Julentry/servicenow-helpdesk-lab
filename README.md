...
![Incident Created](screenshots/01-incident-created.png)
![Work Notes](screenshots/02-incident-work-note.png)
![Incident Resolved](screenshots/03-incident-resolved.png)
...
## Incident Scenario
User reports Outlook login failure after a password change. Helpdesk investigates and restores access.
...
The helpdesk technician added notes indicating investigation and troubleshooting steps.
